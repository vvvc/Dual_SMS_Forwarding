...
- ✨ 新增 无可用wifi打开AP配网
- ✨ 新增 双卡配置及AT查询
- ✨ 新增 mDNS 自定义修改（可用 `http://自定义.local` 访问）
- ✨ -----------------以下原作者新增---------------------
- ✨ 新增 mDNS 访问（可用 `http://sms.local` 访问）
...
| 硬件 | 价格 | 链接 |
|------|------|------|
| ESP32C3 Super Mini | ¥9.5 | 不推荐YX，有概率买到wifi信号不好的 |
| ML307R-DC 移动联通 核心板 不能来电提醒 | ¥16.8首单 | [度云物联旗舰店](https://detail.tmall.com/item.htm?abbucket=13&id=709657795396) 貌似天线+1元 |
| ML307A-DSLN  全网通可来电提醒 | ¥28.8 | [度云物联旗舰店](https://detail.tmall.com/item.htm?id=767117924665) 我买的送天线 |
...
<img src="assets/6TO12.png" width="800" />
